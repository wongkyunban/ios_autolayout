...
//  zf
//
//  Created by waterway on 2016/12/26.
...
extension UIView {
    ...
    struct Wong_AssociatedObjectKey {
    ...
    override open class func initialize() {
        struct Wong_AutoLayoutLoad {
            static var token: Int = 0
        }
        if Wong_AutoLayoutLoad.token == 0 {
            Wong_AutoLayoutLoad.token = 1
            let addConstraint = class_getInstanceMethod(self, #selector(UIView.addConstraint(_:)))
            let Wong_AddConstraint = class_getInstanceMethod(self, #selector(UIView.Wong_AddConstraint(_:)))
            method_exchangeImplementations(addConstraint, Wong_AddConstraint)
        }
    }
    ...
    fileprivate var currentConstraint: NSLayoutConstraint! {
        set {
            objc_setAssociatedObject(self, &Wong_AssociatedObjectKey.kCurrentConstraints, newValue, .OBJC_ASSOCIATION_RETAIN_NONATOMIC)
        }
        
        get {
            let value = objc_getAssociatedObject(self, &Wong_AssociatedObjectKey.kCurrentConstraints)
            if value != nil {
     ...
     */
    @discardableResult
    public func Wong_RemoveConstraint(_ attribute: NSLayoutAttribute) -> UIView {
     ...
     */
    @discardableResult
    public func Wong_RemoveConstraint(_ attribute: NSLayoutAttribute, item: UIView!) -> UIView {
        if item == nil {
            self.Wong_RemoveConstraint(attribute)
        }else {
            for constraint in self.constraints {
                if constraint.firstAttribute == attribute &&
     ...
     */
    @discardableResult
    public func Wong_RemoveConstraint(_ attribute: NSLayoutAttribute, item: UIView!, toItem: UIView!) -> UIView {
        for constraint in self.constraints {
            if constraint.firstAttribute == attribute &&
                constraint.firstItem === item  &&
     ...
     */
    @discardableResult
    public func Wong_PriorityLow() -> UIView {
     ...
     */
    @discardableResult
    public func Wong_PriorityHigh() -> UIView {
     ...
     */
    @discardableResult
    public func Wong_PriorityRequired() -> UIView {
     ...
     */
    @discardableResult
    public func Wong_PriorityFitting() -> UIView {
     ...
     */
    @discardableResult
    public func Wong_Priority(_ value: CGFloat) -> UIView {
     ...
     */
    @discardableResult
    public func Wong_Left(_ space: CGFloat) -> UIView {
     ...
     */
    @discardableResult
    public func Wong_Left(_ space: CGFloat, toView: UIView!) -> UIView {
     ...
     */
    @discardableResult
    public func Wong_LeftEqual(_ view: UIView) -> UIView {
        return self.Wong_LeftEqual(view, offset: 0)
    }
     ...
     */
    @discardableResult
    public func Wong_LeftEqual(_ view: UIView, offset: CGFloat) -> UIView {
     ...
     */
    @discardableResult
    public func Wong_Right(_ space: CGFloat) -> UIView {
     ...
     */
    @discardableResult
    public func Wong_Right(_ space: CGFloat, toView: UIView!) -> UIView {
        var toAttribute = NSLayoutAttribute.left
        if toView.superview == nil {
            toAttribute = .right
        }else if toView.superview !== self.superview {
     ...
     */
    @discardableResult
    public func Wong_RightEqual(_ view: UIView) -> UIView {
        return self.Wong_RightEqual(view, offset: 0)
    }
     ...
     */
    @discardableResult
    public func Wong_RightEqual(_ view: UIView, offset: CGFloat) -> UIView {
        var toAttribute = NSLayoutAttribute.right
     ...
     */
    @discardableResult
    public func Wong_Right(_ space: CGFloat, keepWidthConstraint: Bool) -> UIView {
        self.setKeepWidthConstraint(keepWidthConstraint)
        return self.Wong_Right(space)
    }
     ...
     */
    @discardableResult
    public func Wong_Right(_ space: CGFloat, toView: UIView!, keepWidthConstraint: Bool) -> UIView {
        self.setKeepWidthConstraint(keepWidthConstraint)
        return self.Wong_Right(space, toView: toView)
    }
     ...
     */
    @discardableResult
    public func Wong_RightEqual(_ view: UIView, keepWidthConstraint: Bool) -> UIView {
        self.setKeepWidthConstraint(keepWidthConstraint)
        return self.Wong_RightEqual(view)
    }
     ...
     */
    @discardableResult
    public func Wong_RightEqual(_ view: UIView, offset: CGFloat, keepWidthConstraint: Bool) -> UIView {
        self.setKeepWidthConstraint(keepWidthConstraint)
        return Wong_RightEqual(view, offset: offset)
    }
     ...
     */
    @discardableResult
    public func Wong_Leading(_ space: CGFloat) -> UIView {
     ...
     */
    @discardableResult
    public func Wong_Leading(_ space: CGFloat, toView: UIView!) -> UIView {
     ...
     */
    @discardableResult
    public func Wong_LeadingEqual(_ view: UIView) -> UIView {
        return self.Wong_LeadingEqual(view, offset: 0)
    }
     ...
     */
    @discardableResult
    public func Wong_LeadingEqual(_ view: UIView, offset: CGFloat) -> UIView {
     ...
     */
    @discardableResult
    public func Wong_Trailing(_ space: CGFloat) -> UIView {
     ...
     */
    @discardableResult
    public func Wong_Trailing(_ space: CGFloat, toView: UIView!) -> UIView {
        var toAttribute = NSLayoutAttribute.leading
        if toView.superview == nil {
     ...
     */
    @discardableResult
    public func Wong_TrailingEqual(_ view: UIView) -> UIView {
        return self.Wong_TrailingEqual(view, offset: 0)
    }
     ...
     */
    @discardableResult
    public func Wong_TrailingEqual(_ view: UIView, offset: CGFloat) -> UIView {
        var toAttribute = NSLayoutAttribute.trailing
     ...
     */
    @discardableResult
    public func Wong_Top(_ space: CGFloat) -> UIView {
     ...
     */
    @discardableResult
    public func Wong_Top(_ space: CGFloat, toView: UIView!) -> UIView {
     ...
     */
    @discardableResult
    public func Wong_TopEqual(_ view: UIView) -> UIView {
        return self.Wong_TopEqual(view, offset: 0)
    }
     ...
     */
    @discardableResult
    public func Wong_TopEqual(_ view: UIView, offset: CGFloat) -> UIView {
     ...
     */
    @discardableResult
    public func Wong_Bottom(_ space: CGFloat) -> UIView {
     ...
     */
    @discardableResult
    public func Wong_Bottom(_ space: CGFloat, toView: UIView!) -> UIView {
        var toAttribute = NSLayoutAttribute.top
     ...
     */
    @discardableResult
    public func Wong_BottomEqual(_ view: UIView) -> UIView {
        return self.Wong_BottomEqual(view, offset: 0)
    }
     ...
     */
    @discardableResult
    public func Wong_BottomEqual(_ view: UIView, offset: CGFloat) -> UIView {
        var toAttribute = NSLayoutAttribute.bottom
     ...
     */
    @discardableResult
    public func Wong_Bottom(_ space: CGFloat, keepHeightConstraint: Bool) -> UIView {
        self.setKeepHeightConstraint(keepHeightConstraint)
        return self.Wong_Bottom(space)
    }
     ...
     */
    @discardableResult
    public func Wong_Bottom(_ space: CGFloat, toView: UIView!, keepHeightConstraint: Bool) -> UIView {
        self.setKeepHeightConstraint(keepHeightConstraint)
        return self.Wong_Bottom(space, toView: toView)
    }
     ...
     */
    @discardableResult
    public func Wong_BottomEqual(_ view: UIView, keepHeightConstraint: Bool) -> UIView {
        self.setKeepHeightConstraint(keepHeightConstraint)
        return self.Wong_BottomEqual(view)
    }
     ...
     */
    @discardableResult
    public func Wong_BottomEqual(_ view: UIView, offset: CGFloat, keepHeightConstraint: Bool) -> UIView {
        self.setKeepHeightConstraint(keepHeightConstraint)
        return self.Wong_BottomEqual(view, offset: offset)
    }
     ...
     */
    @discardableResult
    public func Wong_Width(_ width: CGFloat) -> UIView {
     ...
     */
    @discardableResult
    public func Wong_WidthEqual(_ view: UIView!) -> UIView {
     ...
     */
    @discardableResult
    public func Wong_WidthEqual(_ view: UIView!, ratio: CGFloat) -> UIView {
     ...
     */
    @discardableResult
    public func Wong_WidthAuto() -> UIView {
        if self is UILabel {
     ...
     */
    @discardableResult
    public func Wong_Width(_ width: CGFloat, keepRightConstraint: Bool) -> UIView {
        self.setKeepRightConstraint(keepRightConstraint)
        return self.Wong_Width(width)
    }
     ...
     */
    @discardableResult
    public func Wong_WidthEqual(_ view: UIView!, keepRightConstraint: Bool) -> UIView {
        self.setKeepRightConstraint(keepRightConstraint)
        return self.Wong_WidthEqual(view)
    }
     ...
     */
    @discardableResult
    public func Wong_WidthEqual(_ view: UIView!, ratio: CGFloat, keepRightConstraint: Bool) -> UIView {
        self.setKeepRightConstraint(keepRightConstraint)
        return self.Wong_WidthEqual(view, ratio: ratio)
    }
     ...
     */
    @discardableResult
    public func Wong_WidthAutoKeepRightConstraint(_ keepRightConstraint: Bool) -> UIView {
        self.setKeepRightConstraint(keepRightConstraint)
        return self.Wong_WidthAuto()
    }
     ...
     */
    @discardableResult
    public func Wong_HeightWidthRatio(_ ratio: CGFloat) -> UIView {
     ...
     */
    @discardableResult
    public func Wong_Height(_ height: CGFloat) -> UIView {
     ...
     */
    @discardableResult
    public func Wong_HeightEqual(_ view: UIView!) -> UIView {
     ...
     */
    @discardableResult
    public func Wong_HeightEqual(_ view: UIView!, ratio: CGFloat) -> UIView {
     ...
     */
    @discardableResult
    public func Wong_HeightAuto() -> UIView {
        if self is UILabel {
            let selfLabel = self as! UILabel
            if selfLabel.numberOfLines != 0 {
     ...
     */
    @discardableResult
    public func Wong_Height(_ height: CGFloat, keepBottomConstraint: Bool) -> UIView {
        self.setKeepBottomConstraint(keepBottomConstraint)
        return self.Wong_Height(height)
    }
     ...
     */
    @discardableResult
    public func Wong_HeightEqual(_ view: UIView!, keepBottomConstraint: Bool) -> UIView {
        self.setKeepBottomConstraint(keepBottomConstraint)
        return self.Wong_HeightEqual(view)
    }
     ...
     */
    @discardableResult
    public func Wong_HeightEqual(_ view: UIView!, ratio: CGFloat, keepBottomConstraint: Bool) -> UIView {
        self.setKeepBottomConstraint(keepBottomConstraint)
        return self.Wong_HeightEqual(view, ratio: ratio)
    }
     ...
     */
    @discardableResult
    public func Wong_HeightAutoKeepBottomConstraint(_ keepBottomConstraint: Bool) -> UIView {
        self.setKeepBottomConstraint(keepBottomConstraint)
        return self.Wong_HeightAuto()
    }
     ...
     */
    @discardableResult
    public func Wong_WidthHeightRatio(_ ratio: CGFloat) -> UIView {
     ...
     */
    @discardableResult
    public func Wong_CenterX(_ x: CGFloat) -> UIView {
     ...
     */
    @discardableResult
    public func Wong_CenterXEqual(_ view: UIView!) -> UIView {
     ...
     */
    @discardableResult
    public func Wong_CenterXEqual(_ view: UIView, offset: CGFloat) -> UIView {
     ...
     */
    @discardableResult
    public func Wong_CenterX(_ x: CGFloat, toView: UIView!) -> UIView {
     ...
     */
    @discardableResult
    public func Wong_CenterY(_ y: CGFloat) -> UIView {
     ...
     */
    @discardableResult
    public func Wong_CenterYEqual(_ view: UIView!) -> UIView {
     ...
     */
    @discardableResult
    public func Wong_CenterYEqual(_ view: UIView!, offset: CGFloat) -> UIView {
     ...
     */
    @discardableResult
    public func Wong_CenterY(_ y: CGFloat, toView: UIView!) -> UIView {
     ...
     */
    @discardableResult
    public func Wong_BaseLine(_ space: CGFloat) -> UIView {
     ...
     */
    @discardableResult
    public func Wong_BaseLine(_ space: CGFloat, toView: UIView!) -> UIView {
        var toAttribute = NSLayoutAttribute.top
     ...
     */
    @discardableResult
    public func Wong_BaseLineEqual(_ view: UIView!) -> UIView {
        return self.Wong_BaseLineEqual(view, offset: 0)
    }
     ...
     */
    @discardableResult
    public func Wong_BaseLineEqual(_ view: UIView!, offset: CGFloat) -> UIView {
     ...
     */
    @discardableResult
    public func Wong_Center(_ x: CGFloat, y: CGFloat) -> UIView {
        return self.Wong_CenterX(x).Wong_CenterY(y)
    }
     ...
     */
    @discardableResult
    public func Wong_Center(_ x: CGFloat, y: CGFloat, toView: UIView!) -> UIView {
        return self.Wong_CenterX(x, toView: toView).Wong_CenterY(y, toView: toView)
    }
     ...
     */
    @discardableResult
    public func Wong_CenterEqual(_ view: UIView!) -> UIView {
        return self.Wong_CenterXEqual(view).Wong_CenterYEqual(view)
    }
     ...
     */
    @discardableResult
    public func Wong_CenterEqual(_ view: UIView!, offsetX: CGFloat, offsetY: CGFloat) -> UIView {
        return self.Wong_CenterXEqual(view, offset: offsetX).Wong_CenterYEqual(view, offset: offsetY)
    }
     ...
     */
    @discardableResult
    public func Wong_Frame(_ left: CGFloat, top: CGFloat, width: CGFloat, height: CGFloat) -> UIView {
        return self.Wong_Left(left).Wong_Top(top).Wong_Width(width).Wong_Height(height)
    }
     ...
     */
    @discardableResult
    public func Wong_Frame(_ left: CGFloat, top: CGFloat, width: CGFloat, height: CGFloat, toView: UIView!) -> UIView {
        return self.Wong_Left(left, toView: toView).Wong_Top(top, toView: toView).Wong_Width(width).Wong_Height(height)
    }
     ...
     */
    @discardableResult
    public func Wong_Size(_ width: CGFloat, height: CGFloat) -> UIView {
        return self.Wong_Width(width).Wong_Height(height)
    }
     ...
     */
    @discardableResult
    public func Wong_SizeEqual(_ view: UIView!) -> UIView {
        self.Wong_WidthEqual(view).Wong_HeightEqual(view)
        return self
    }
     ...
     */
    @discardableResult
    public func Wong_AutoSize(left: CGFloat, top: CGFloat, right: CGFloat, bottom: CGFloat) -> UIView {
        return self.Wong_Left(left).Wong_Top(top).Wong_Right(right).Wong_Bottom(bottom)
    }
     ...
     */
    @discardableResult
    public func Wong_AutoSize(left: CGFloat, top: CGFloat, right: CGFloat, bottom: CGFloat, toView: UIView!) -> UIView {
        return self.Wong_Left(left, toView: toView).Wong_Top(top, toView: toView).Wong_Right(right, toView: toView).Wong_Bottom(bottom, toView: toView)
    }
     ...
     */
    @discardableResult
    public func Wong_AutoWidth(left: CGFloat, top: CGFloat, right: CGFloat, height: CGFloat) -> UIView {
        return self.Wong_Left(left).Wong_Top(top).Wong_Right(right).Wong_Height(height)
    }
     ...
     */
    @discardableResult
    public func Wong_AutoWidth(left: CGFloat, top: CGFloat, right: CGFloat, height: CGFloat, toView: UIView!) -> UIView {
        return self.Wong_Left(left, toView: toView).Wong_Top(top, toView: toView).Wong_Right(right, toView: toView).Wong_Height(height)
    }
     ...
     */
    @discardableResult
    public func Wong_AutoHeight(left: CGFloat, top: CGFloat, width: CGFloat, bottom: CGFloat) -> UIView {
        return self.Wong_Left(left).Wong_Top(top).Wong_Width(width).Wong_Bottom(bottom)
    }
     ...
     */
    @discardableResult
    public func Wong_AutoHeight(left: CGFloat, top: CGFloat, width: CGFloat, bottom: CGFloat, toView: UIView!) -> UIView {
        return self.Wong_Left(left, toView: toView).Wong_Top(top, toView: toView).Wong_Width(width).Wong_Bottom(bottom, toView: toView)
    }
    ...
    @objc fileprivate func Wong_AddConstraint(_ constraint: NSLayoutConstraint) {
        ...
        if constraintClassString.hasPrefix("NS") {
            ...
            case .height:
                if constraintClassString == "NSContentSizeLayoutConstraint" {
                    ...
                    self.Wong_AddConstraint(constraint)
                    return
                }else {
    ...
    fileprivate func setRightConstraint(_ constraint: NSLayoutConstraint!) {
        objc_setAssociatedObject(self, &Wong_AssociatedObjectKey.kRightConstraint, constraint, .OBJC_ASSOCIATION_RETAIN_NONATOMIC)
    }
    
    fileprivate func rightConstraint() -> NSLayoutConstraint! {
        return objc_getAssociatedObject(self, &Wong_AssociatedObjectKey.kRightConstraint) as? NSLayoutConstraint
    }
    
    fileprivate func setBottomConstraint(_ constraint: NSLayoutConstraint!) {
        objc_setAssociatedObject(self, &Wong_AssociatedObjectKey.kBottomConstraint, constraint, .OBJC_ASSOCIATION_RETAIN_NONATOMIC)
    }
    
    fileprivate func bottomConstraint() -> NSLayoutConstraint! {
        return objc_getAssociatedObject(self, &Wong_AssociatedObjectKey.kBottomConstraint) as? NSLayoutConstraint
    }
    
    fileprivate func setEquelWidthConstraint(_ constraint: NSLayoutConstraint!) {
        objc_setAssociatedObject(self, &Wong_AssociatedObjectKey.kEquelWidthConstraint, constraint, .OBJC_ASSOCIATION_RETAIN_NONATOMIC)
    }
    
    fileprivate func equelWidthConstraint() -> NSLayoutConstraint! {
        return objc_getAssociatedObject(self, &Wong_AssociatedObjectKey.kEquelWidthConstraint) as? NSLayoutConstraint
    }
    
    fileprivate func setAutoWidthConstraint(_ constraint: NSLayoutConstraint!) {
        objc_setAssociatedObject(self, &Wong_AssociatedObjectKey.kAutoWidthConstraint, constraint, .OBJC_ASSOCIATION_RETAIN_NONATOMIC)
    }
    
    fileprivate func autoWidthConstraint() -> NSLayoutConstraint! {
        return objc_getAssociatedObject(self, &Wong_AssociatedObjectKey.kAutoWidthConstraint) as? NSLayoutConstraint
    }
    
    fileprivate func setSelfWidthConstraint(_ constraint: NSLayoutConstraint!) {
        objc_setAssociatedObject(self, &Wong_AssociatedObjectKey.kSelfWidthConstraint, constraint, .OBJC_ASSOCIATION_RETAIN_NONATOMIC)
    }
    
    fileprivate func selfWidthConstraint() -> NSLayoutConstraint! {
        return objc_getAssociatedObject(self, &Wong_AssociatedObjectKey.kSelfWidthConstraint) as? NSLayoutConstraint
    }
    
    fileprivate func setEquelHeightConstraint(_ constraint: NSLayoutConstraint!) {
        objc_setAssociatedObject(self, &Wong_AssociatedObjectKey.kEquelHeightConstraint, constraint, .OBJC_ASSOCIATION_RETAIN_NONATOMIC)
    }
    
    fileprivate func equelHeightConstraint() -> NSLayoutConstraint! {
        return objc_getAssociatedObject(self, &Wong_AssociatedObjectKey.kEquelHeightConstraint) as? NSLayoutConstraint
    }
    
    fileprivate func setAutoHeightConstraint(_ constraint: NSLayoutConstraint!) {
        objc_setAssociatedObject(self, &Wong_AssociatedObjectKey.kAutoHeightConstraint, constraint, .OBJC_ASSOCIATION_RETAIN_NONATOMIC)
    }
    
    fileprivate func autoHeightConstraint() -> NSLayoutConstraint! {
        return objc_getAssociatedObject(self, &Wong_AssociatedObjectKey.kAutoHeightConstraint) as? NSLayoutConstraint
    }
    
    fileprivate func setSelfHeightConstraint(_ constraint: NSLayoutConstraint!) {
        objc_setAssociatedObject(self, &Wong_AssociatedObjectKey.kSelfHeightConstraint, constraint, .OBJC_ASSOCIATION_RETAIN_NONATOMIC)
    }
    
    fileprivate func selfHeightConstraint() -> NSLayoutConstraint! {
        return objc_getAssociatedObject(self, &Wong_AssociatedObjectKey.kSelfHeightConstraint) as? NSLayoutConstraint
    }
    
    fileprivate func setKeepWidthConstraint(_ isKeep: Bool) {
        objc_setAssociatedObject(self, &Wong_AssociatedObjectKey.kKeepWidthConstraint, NSNumber(value: isKeep as Bool), .OBJC_ASSOCIATION_RETAIN_NONATOMIC)
    }
    
    fileprivate func keepWidthConstraint() -> Bool {
        let value = objc_getAssociatedObject(self, &Wong_AssociatedObjectKey.kKeepWidthConstraint) as? NSNumber
        return value != nil ? value!.boolValue : false
    }
    
    fileprivate func setKeepHeightConstraint(_ isKeep: Bool) {
        objc_setAssociatedObject(self, &Wong_AssociatedObjectKey.kKeepHeightConstraint, NSNumber(value: isKeep as Bool), .OBJC_ASSOCIATION_RETAIN_NONATOMIC)
    }
    
    fileprivate func keepHeightConstraint() -> Bool {
        let value = objc_getAssociatedObject(self, &Wong_AssociatedObjectKey.kKeepHeightConstraint) as? NSNumber
        return value != nil ? value!.boolValue : false
    }
    
    fileprivate func setKeepBottomConstraint(_ isKeep: Bool) {
        objc_setAssociatedObject(self, &Wong_AssociatedObjectKey.kKeepBottomConstraint, NSNumber(value: isKeep as Bool), .OBJC_ASSOCIATION_RETAIN_NONATOMIC)
    }
    
    fileprivate func keepBottomConstraint() -> Bool {
        let value = objc_getAssociatedObject(self, &Wong_AssociatedObjectKey.kKeepBottomConstraint) as? NSNumber
        return value != nil ? value!.boolValue : false
    }
    
    fileprivate func setKeepRightConstraint(_ isKeep: Bool) {
        objc_setAssociatedObject(self, &Wong_AssociatedObjectKey.kKeepRightConstraint, NSNumber(value: isKeep as Bool), .OBJC_ASSOCIATION_RETAIN_NONATOMIC)
    }
    
    fileprivate func keepRightConstraint() -> Bool {
        let value = objc_getAssociatedObject(self, &Wong_AssociatedObjectKey.kKeepRightConstraint) as? NSNumber
        return value != nil ? value!.boolValue : false
    }
    ...
    fileprivate func createLineWithTag(_ lineTag: Int)  -> Wong_Line! {
        var line: Wong_Line!
        for view in self.subviews {
            if view is Wong_Line && view.tag == lineTag {
                line = view as! Wong_Line
                break
            }
        }
        if line == nil {
    ...
    //MARK: -自动添加底部线和顶部线-
    @discardableResult
    public func Wong_AddBottomLine(_ height: CGFloat, color: UIColor) -> UIView {
        return self.Wong_AddBottomLine(height, color: color, marge: 0)
    }
    
    @discardableResult
    public func Wong_AddBottomLine(_ height: CGFloat, color: UIColor, marge: CGFloat) -> UIView {
        let line = self.createLineWithTag(Wong_Tag.kBottomLine)
        line?.backgroundColor = color
        return line!.Wong_Right(marge).Wong_Left(marge).Wong_Height(height).Wong_BaseLine(0)
    }
    
    @discardableResult
    public func Wong_AddTopLine(_ height: CGFloat, color: UIColor) -> UIView {
        return self.Wong_AddTopLine(height, color: color, marge: 0)
    }
    
    @discardableResult
    public func Wong_AddTopLine(_ height: CGFloat, color: UIColor, marge: CGFloat) -> UIView {
        let line = self.createLineWithTag(Wong_Tag.kTopLine)
        line?.backgroundColor = color
        return line!.Wong_Right(marge).Wong_Left(marge).Wong_Height(height).Wong_Top(0)
    }
